...
module.exports = {
	...
	loadAllDataStore : function(callback){
		var self = this;
		this.loadThingStore(function(){
			self.loadEventStore(function(){
				self.loadListenerEndpointStore(callback);
			})
		})		
	},
	...
	sendAjaxRequest: function(url, method, data, callback) {
		this.saveData(url, method, data, callback);
	},
...
//	},
	...
	///////////////////////////////////////////////////////////	
	getEventByArrayCriteria: function(...criteria) {
		const list = EventStore.getDataByArrayCriteria(criteria);
		return list;
	},
	...
	///////////////////////////////////////////////////////////	
	getListenerByArrayCriteria: function(...criteria) {
		const list = ListenerEndpointStore.getDataByArrayCriteria(criteria);
		return list;
	},
